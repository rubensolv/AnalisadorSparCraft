...
public enum UnitType {
	DRAGOON, ZEALOT, ARCHON, MARINE, VULTURE, TANK, FIREBAT, GOLIATH, ZERGLING, HYDRALISK, MUTALISK, ULTRALISK;
	...
	public static ArrayList<String> getNomeUnits(){
	...
	public static String getSiglaByName(String name){
		HashMap<String, String> unitSiglah = new HashMap<>();
